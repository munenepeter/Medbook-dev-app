...
class Data extends Database {
  ...
  public function _insertDataTest($nameofpatient, $dateofbirth, $comments, $gender, $typeofservice) {
    ...
    $id = $this->connect()->prepare("SELECT `patient_id` FROM `tbl_patient` WHERE `patient_name`= ?")->execute([$nameofpatient]);
  ...
  private function insert($table, $parameters) {
    ...
    if (!$statement->execute($parameters)) {
      throw new \Exception("Something is up with your Insert! $sql");
      die();
    }
  ...
  // public function insedrtData($nameofpatient, $dateofbirth, $comments, $gender, $typeofservice) {
